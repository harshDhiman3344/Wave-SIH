        ...
        <div className="reports__grid">
          ...
          <div className="reports__card reports__card--danger">
            <div className="reports__card-header">
              <div className="reports__card-icon reports__card-icon--danger">🌊</div>
              <div>
          ...
          <div className="reports__card reports__card--warning">
            <div className="reports__card-header">
              <div className="reports__card-icon reports__card-icon--warning">⚠️</div>
              <div>
          ...
          <div className="reports__card reports__card--success">
            <div className="reports__card-header">
              <div className="reports__card-icon reports__card-icon--success">✅</div>
              <div>
